...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/0af3df0032537906d1a097d9661bc40a6b1eb009/R/Reactant/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/EnzymeAD/Reactant.jl.git (revision: `71941115a1d4c9fdb55ac608af74b9ceffd80547`)

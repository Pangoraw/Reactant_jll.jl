...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/cb37fd415ac53ff9e3d6519949b68da4186f7dc6/R/Reactant/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/EnzymeAD/Reactant.jl.git (revision: `036cb752b47976018d3ed87a142b136ec3e6836e`)

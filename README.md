...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/fcaed0358d41e09dd13e5dd525151049f26013bc/R/Reactant/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/EnzymeAD/Reactant.jl.git (revision: `3c2211fe36f4e7665669be863386924a4a7513dd`)

...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/8cb80d5be7c69d876a86ed95ba1cf3ed9ca8a49b/R/Reactant/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/EnzymeAD/Reactant.jl.git (revision: `d07d8941fb14ef8963f0e37bd0067e028473124f`)

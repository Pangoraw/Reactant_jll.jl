...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/09c36b93214d7b84ac7f18b42f46ff6bf0cb04c7/R/Reactant/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/EnzymeAD/Reactant.jl.git (revision: `3a51bf59d32f0b0f962f6364e61d75a812872445`)
